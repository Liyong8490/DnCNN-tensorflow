...
parser.add_argument('--model-stop', dest='model_stop', type=int, default=1, help='validate stop epoch')
parser.add_argument('--sigma', dest='sigma', type=int, default=25, help='noise level')
parser.add_argument('--checkpoint-dir', dest='checkpoint_dir', default='./checkpoints', help='models are saved here')
